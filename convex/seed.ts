...
const IMG = {
  ribeye:    '/images/products/ribeye_steak.png',
  lamb:      '/images/products/leg_of_lamb.png',
  cuts:      '/images/products/beef_tenderloin.png',
  minced:    '/images/products/minced_beef.png',
  meat:      '/images/products/beef_cubes.png',
  kofta:     '/images/products/kofta_meat.png',
  burgers:   '/images/products/beef_burger_patties.png',
  goat:      '/images/products/goat_meat.png',
  offal:     '/images/products/beef_liver.png',
  frozen:    '/images/products/frozen_minced_beef.png',
  butcher:   '/images/products/beef_brisket.png',
  steak:     '/images/products/sirloin_steak.png',
  tbone:     '/images/products/t_bone_steak.png',
  grill:     '/images/products/sausages.png',
  kebab:     '/images/products/kebab.png',
  chops:     '/images/products/lamb_chops.png',
  frenchRibeye:  '/images/products/french_ribeye.png',
  frenchTenderloin: '/images/products/veal_steak.png',
  frenchEntrecote: '/images/products/french_entrecote.png',
  frenchBavette: '/images/products/french_bavette.png',
  frenchOnglet: '/images/products/french_onglet.png',
  frenchCharolais: '/images/products/french_charolais.png',
  frenchLimousin: '/images/products/french_limousin.png',
  frenchRibs: '/images/products/beef_ribs.png',
};
