...
const IMG = {
  ...
  tbone:     'https://images.unsplash.com/photo-1546964124-0cce460f38ef?w=600&q=80',
  ...
  chops:     'https://images.unsplash.com/photo-1432139509613-5c4255815697?w=600&q=80',
  frenchRibeye:  'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=600&q=80',
  frenchTenderloin: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=600&q=80',
  frenchEntrecote: 'https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80',
  frenchBavette: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80',
  frenchOnglet: 'https://images.unsplash.com/photo-1546964124-0cce460f38ef?w=600&q=80',
  frenchCharolais: 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=600&q=80',
  frenchLimousin: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=600&q=80',
  frenchRibs: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80',
};
...
export default mutation({
  handler: async (ctx) => {
    ...
    await ctx.db.insert('products', p({
      ...
      categorySlug: 'beef', subcategory: null,
      images: [IMG.butcher], basePrice: 180,
      variants: [
